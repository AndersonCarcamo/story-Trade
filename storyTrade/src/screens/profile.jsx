...
//         setStarRating(Math.floor(userData.rating)); // Redondear hacia abajo la calificación
//         setTrades(userData.exchanges); // Establecer el número de intercambios
//         setUserGenres(userData.genres); // Establecer los géneros del usuario
...
//   useEffect(() => {
//     const getGenres = async () => {
//       console.log("Aqui se ejecuta 0")
//       try {
//         console.log("Aqui se ejecuta 1")
//         const token = await AsyncStorage.getItem('userToken');
//         const availableGenresResponse = await axios.get('https://dbstorytrada-b5fcff8487d7.herokuapp.com/genres', {
//           headers: {
//             Authorization: `Bearer ${token}`
...
//         console.log("Aqui estan los generos:")
//         console.log(availableGenresResponse.data); // Verifica la respuesta de la API
//         setAvailableGenres(availableGenresResponse.data);
//       } catch (error) {
//         console.error(error);
//         Alert.alert('Error', 'No se pudo cargar los Géneros');
...
//       >
//         <Image
//           source={{ uri: item.book_info.image ? item.book_info.image : 'https://via.placeholder.com/150' }}
