...
import { Video } from 'expo-av';  // Importar Video de expo-av
import defaultImage from '../assets/default_image.jpg';  // Asegúrate de tener esta imagen predeterminada
import { showMessage } from 'react-native-flash-message';  // Para mostrar mensajes
